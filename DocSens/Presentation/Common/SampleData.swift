...
/// Static sample data — used ONLY in SwiftUI previews.
/// The live app starts empty and is populated through real file imports.
enum SampleData {
    ...
    static let riskFlags: [UUID: [RiskFlagEntity]] = {
        [
            ...
            empId: [
                ...
                RiskFlagEntity(keyword: "work for hire",   category: .ipAssignment, severity: .high,   excerptContext: "…Employee hereby assigns all intellectual property created during employment to Horizon Tech Inc.…"),
                RiskFlagEntity(keyword: "arbitration",     category: .arbitration,  severity: .high,   excerptContext: "…The parties agree to submit any disputes to binding arbitration under AAA rules…"),
            ...
            sowId: [
                RiskFlagEntity(keyword: "work for hire",    category: .ipAssignment, severity: .high,   excerptContext: "…All deliverables produced under this Statement of Work shall be considered work for hire…"),
                RiskFlagEntity(keyword: "indemnify",        category: .liability,    severity: .high,   excerptContext: "…Contractor shall indemnify, defend, and hold harmless Spark Studios from any third-party claims…"),
                RiskFlagEntity(keyword: "late fee",         category: .penalties,    severity: .low,    excerptContext: "…Invoices unpaid after 30 days will incur a late fee of 1.5 percent per month…"),
                RiskFlagEntity(keyword: "non-solicitation", category: .nonCompete,   severity: .medium, excerptContext: "…Contractor agrees not to directly solicit any clients or employees of Spark Studios for 12 months…"),
            ],
        ]
    }()
    ...
    Employee agrees not to engage in any non-compete activity within a 50-mile radius for 24 months. Employee hereby assigns all intellectual property to Horizon Tech Inc. Disputes subject to arbitration. This Agreement shall auto-renew unless 90-day notice given.
    """
    ...
    All deliverables shall be considered work for hire. Contractor shall indemnify and hold harmless Spark Studios from third-party claims. Invoices unpaid after 30 days incur a late fee of 1.5 percent per month.
    """
